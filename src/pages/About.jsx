          ...
          <div className="flex flex-wrap items-center -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-7/12 ">
              <motion.div
                ...
                <p className="mb-8 text-base text-gray-500">
                    SkyLine Digital stands out as a company by 
                    introducing a new era of Remote Team Extension. 
                    We've built one of the largest databases of software 
                    engineers and established all the necessary support 
                    systems for seamless remote work with our clients. 
                    This includes office spaces, recruiting, hiring, 
                    management, administrative support, infrastructure, 
                    and more—all founded on a strong partnership approach.
                </p>
              </motion.div>
              <motion.div
                      variants={{
