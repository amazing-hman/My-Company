...
const Contact = () => {
  ...
  const initialState = {
    ...
    useEffect(() => {
        document.title="SkyLine Digital | Contact";
    },[]);
    const ref = useRef();
      ...
      <div className="bg-gradient-to-br from-blue-100">
              ...
              <div className="-mx-4 flex flex-wrap lg:justify-between">
                    ...
                    >      
                      ...
                      <div className="w-full">
                        ...
                        <p className="text-body-color text-base">
                          35 Boulevard Saint-Germain, Paris 75005, France
                        </p>
                      </div>
                ...
                >
                  <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                    <form ref = {ref} name="sentMessage" onSubmit={handleSubmit}>
                      <motion.div 
                        variants={{
                                      visible: { opacity: 1, x: 0 },
                                      hidden: { opacity: 0, x: 75 },
                      ...
                      >
                        <input
                          ...
                          required
                          className="form-control text-body-color border-[f0f0f0] focus:border-blue-500 w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                      ...
                      >
                        <textarea
                          ...
                          onChange={handleChange}
                          required
                          className="form-control text-body-color border-[f0f0f0] focus:border-blue-500 w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                        ></textarea>
                      </motion.div>
                      <motion.div 
                        variants={{
        ...
        <div className="h-[42rem] sm:mt-20 mt-[20%]">
          ...
          <div className="flex justify-center mt-20" id="maps">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d10503.819290670193!2d2.341075399387568!3d48.84000041851412!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sus!4v1732495133783!5m2!1sen!2sus"
              allowFullScreen
              loading="lazy"
              title="Google Map of Paris"
