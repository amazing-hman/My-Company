          ...
          <>
            <div className="container px-6 py-12 mx-auto">
              <div className="grid items-center gap-4 xl:grid-cols-5">
                <div className="max-w-2xl mx-auto rounded shadow-md bg-white p-6 my-8 space-y-4 text-center xl:col-span-2 xl:text-left testimonial-card">
                ...
                <div className="p-6 xl:col-span-3">
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="grid content-center gap-4">
                      <div className="p-6 rounded shadow-md bg-white testimonial-card">
                        <p>
                          SkyLine Digital built our website from the ground up,
                        ...
                        <div className="flex items-center mt-4 space-x-4">
                          ...
                          />
                          <div>
                            <p className="text-md font-semibold">Louis Martin</p>
                      ...
                      <div className="p-6 rounded shadow-md bg-white testimonial-card">
                        <p>
                          SkyLine Digital transformed our outdated website 
                    ...
                    <div className="grid content-center gap-4">
                      <div className="p-6 rounded shadow-md bg-white testimonial-card">
                        <p>
                          After a major security scare, we turned to SkyLine Digital for help. 
                      ...
                      <div className="p-6 rounded shadow-md bg-white testimonial-card">
                        <p>
                          ...
                          operations, and SkyLine Digital delivered beyond our
            ...
            <div className="container px-6 py-12 mx-auto">
              <div className="grid items-center gap-4 xl:grid-cols-5">
                <motion.div
                  ...
                  className="max-w-2xl mx-auto rounded shadow-md bg-white p-6 my-8  space-y-4 text-center xl:col-span-2 xl:text-left testimonial-card"
                >
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="grid content-center gap-4">
                      <motion.div
                        ...
                        className="p-6 rounded-lg shadow-lg bg-white mt-6 testimonial-card"
                      >
                        <p>
                          SkyLine Digital built our website from the ground up,
                           and the result was nothing short of impressive.
                      ...
                      <motion.div
                        ...
                        className="p-6 rounded-lg shadow-lg bg-white testimonial-card"
                      >
                        <p>
                          SkyLine Digital transformed our outdated website 
                          into a modern, responsive platform that’s helped 
